...
@Injectable()
export class MedVisaNavigationService {
  ...
  iconMenu: IMenuItem[] = [
    ...
    //   type:"link",
    //   icon:"account_box",
    //   state:"medVisa/visa-invitation",
    // },
    // {
    //   name:"Visa Extension Invitation",
    //   type:"link",
    //   icon:"account_box",
    //   state:"medVisa/medvisa-extn",
    // },
    {
      name: 'Medical visa Invitation',
      type: 'link',
      icon: 'local_hospital',
      state: 'medVisa/draft-medvisa',
      // state:"",
    },
    {
